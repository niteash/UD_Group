...
export function ScrollVideoReveal() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative h-screen overflow-hidden bg-[#0a0a0a] transition-colors duration-500"
    >
      <video
        ref={videoRef}
        muted
        ...
        className="absolute inset-0 w-full h-full object-cover scale-110 opacity-60 transition-opacity duration-500"
      >
      ...
      <div className="reveal-caption absolute bottom-12 left-6 md:left-10 max-w-md z-10">
        <p className="font-mono text-[#B89851]/80 text-[10px] uppercase tracking-[0.2em] mb-3 transition-colors duration-500">
          {scrollReveal.eyebrow.toUpperCase()}
        </p>
        <h2 className="font-serif font-light text-transparent bg-clip-text bg-gradient-to-r from-[#B89851] via-[#e6c875] to-[#B89851] text-[clamp(2rem,4vw,3.5rem)] leading-tight tracking-tight transition-all duration-500">
          {scrollReveal.heading}
        </h2>
        <ul className="mt-4 space-y-2 text-neutral-300 text-sm font-light leading-relaxed transition-colors duration-500 list-disc list-inside">
